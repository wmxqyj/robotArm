...
enum robot_event_type
{
    ...
    ROBOT_TIMIE_FUNC_EVENT,         /* 时间函数事件：机械臂末端根据时间函数 P(t) 运动 */
    ...
    ROBOT_GET_EEPOSE_EVENT,         /* 获取末端位姿事件 */
    ROBOT_SET_JOINTS_EVENT,         /* 设置关节角度事件 */
    ROBOT_GET_IK_SOLUTION_EVENT,    /* 获取逆解事件 */
    ROBOT_MG996R_SET_ANGLE_EVENT,   /* MG996R 舵机设置角度事件 */
    ROBOT_MG996R_GET_ANGLE_EVENT,   /* MG996R 舵机获取角度事件 */
};
...
uint32_t robot_joint_rotate_to(uint32_t joint_id, enum dir dir, float angle, float velocity, uint32_t acceleration, bool absolute);
